...
@ReactModule(name = ChiaWalletModule.NAME)
class ChiaWalletModule(reactContext: ReactApplicationContext) :
  NativeChiaWalletSpec(reactContext) {
  ...
  companion object {
    const val NAME = "ChiaWallet"

    init {
      System.loadLibrary("chia-wallet")
    }
  }
}