...
// Automated testing checks Java_com_chiawalletsdk_ChiaWalletModule and chiawallet
// by comparing the whole line here.
/*
Java_com_chiawalletsdk_ChiaWalletModule_nativeMultiply(JNIEnv *env, jclass type, jdouble a, jdouble b) {
    return chiawallet::multiply(a, b);
}
*/

// Installer coming from ChiaWalletModule
extern "C"
JNIEXPORT jboolean JNICALL
Java_com_chiawalletsdk_ChiaWalletModule_nativeInstallRustCrate(
    JNIEnv *env,
    jclass type,
    jlong rtPtr,
    ...
    return chiawallet::installRustCrate(*runtime, jsCallInvoker);
}

extern "C"
JNIEXPORT jboolean JNICALL
Java_com_chiawalletsdk_ChiaWalletModule_nativeCleanupRustCrate(JNIEnv *env, jclass type, jlong rtPtr) {
    auto runtime = reinterpret_cast<jsi::Runtime *>(rtPtr);
    return chiawallet::cleanupRustCrate(*runtime);
}