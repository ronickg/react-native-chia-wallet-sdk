...
// it!
#include "chia_wallet_sdk_uniffi.hpp"
...
int8_t uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes(
    RustBuffer a, RustBuffer b, RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex(RustBuffer hex,
                                               RustCallStatus *uniffi_out_err);
RustBuffer uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw(
    RustBuffer hex, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic(
    uint32_t word_count, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_from_entropy(
    RustBuffer entropy, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy(
    RustBuffer phrase, RustCallStatus *uniffi_out_err);
RustBuffer uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed(
    RustBuffer phrase, RustBuffer passphrase, RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_chia_wallet_sdk_uniffi_fn_func_sha256(RustBuffer bytes,
                                             RustCallStatus *uniffi_out_err);
RustBuffer
uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex(RustBuffer bytes,
                                             RustCallStatus *uniffi_out_err);
int8_t uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic(
    RustBuffer phrase, RustCallStatus *uniffi_out_err);
RustBuffer
ffi_chia_wallet_sdk_uniffi_rustbuffer_alloc(uint64_t size,
                                            RustCallStatus *uniffi_out_err);
RustBuffer ffi_chia_wallet_sdk_uniffi_rustbuffer_from_bytes(
    ForeignBytes bytes, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rustbuffer_free(RustBuffer buf,
                                                RustCallStatus *uniffi_out_err);
RustBuffer ffi_chia_wallet_sdk_uniffi_rustbuffer_reserve(
    RustBuffer buf, uint64_t additional, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_u8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_u8(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_u8(
    /*handle*/ uint64_t handle);
uint8_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_u8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_i8(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_i8(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_i8(
    /*handle*/ uint64_t handle);
int8_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_i8(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_u16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_u16(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_u16(
    /*handle*/ uint64_t handle);
uint16_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_u16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_i16(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_i16(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_i16(
    /*handle*/ uint64_t handle);
int16_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_i16(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_u32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_u32(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_u32(
    /*handle*/ uint64_t handle);
uint32_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_u32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_i32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_i32(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_i32(
    /*handle*/ uint64_t handle);
int32_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_i32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_u64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_u64(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_u64(
    /*handle*/ uint64_t handle);
uint64_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_u64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_i64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_i64(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_i64(
    /*handle*/ uint64_t handle);
int64_t ffi_chia_wallet_sdk_uniffi_rust_future_complete_i64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_f32(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_f32(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_f32(
    /*handle*/ uint64_t handle);
float ffi_chia_wallet_sdk_uniffi_rust_future_complete_f32(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_f64(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_f64(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_f64(
    /*handle*/ uint64_t handle);
double ffi_chia_wallet_sdk_uniffi_rust_future_complete_f64(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_pointer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_pointer(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_pointer(
    /*handle*/ uint64_t handle);
void *ffi_chia_wallet_sdk_uniffi_rust_future_complete_pointer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_rust_buffer(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_rust_buffer(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_rust_buffer(
    /*handle*/ uint64_t handle);
RustBuffer ffi_chia_wallet_sdk_uniffi_rust_future_complete_rust_buffer(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
void ffi_chia_wallet_sdk_uniffi_rust_future_poll_void(
    /*handle*/ uint64_t handle, UniffiRustFutureContinuationCallback callback,
    /*handle*/ uint64_t callback_data);
void ffi_chia_wallet_sdk_uniffi_rust_future_cancel_void(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_free_void(
    /*handle*/ uint64_t handle);
void ffi_chia_wallet_sdk_uniffi_rust_future_complete_void(
    /*handle*/ uint64_t handle, RustCallStatus *uniffi_out_err);
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_from_entropy();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_entropy();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex();
uint16_t uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic();
uint32_t ffi_chia_wallet_sdk_uniffi_uniffi_contract_version();
}

// This calls into Rust.

namespace uniffi::chia_wallet_sdk_uniffi {
...
template <typename T> struct Bridging<ReferenceHolder<T>> {
  ...
  static T fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    if (obj.hasProperty(rt, "pointee")) {
      ...
      return uniffi::chia_wallet_sdk_uniffi::Bridging<T>::fromJs(
...
template <> struct Bridging<RustBuffer> {
  static RustBuffer rustbuffer_alloc(int32_t size) {
    ...
    return ffi_chia_wallet_sdk_uniffi_rustbuffer_alloc(size, &status);
  }
  ...
  static RustBuffer fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    try {
      ...
      RustCallStatus status = {UNIFFI_CALL_STATUS_OK};
      auto buf =
          ffi_chia_wallet_sdk_uniffi_rustbuffer_from_bytes(bytes, &status);
  ...
  static jsi::Value toJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker>,
    ...
    ffi_chia_wallet_sdk_uniffi_rustbuffer_free(buf, &status);
...
// Callback function:
// uniffi::chia_wallet_sdk_uniffi::cb::rustfuturecontinuationcallback::UniffiRustFutureContinuationCallback
//
...
namespace uniffi::chia_wallet_sdk_uniffi::cb::rustfuturecontinuationcallback {
using namespace facebook;
...
makeCallbackFunction( // uniffi::chia_wallet_sdk_uniffi::cb::rustfuturecontinuationcallback
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
...
// This method is called from the destructor of NativeChiaWalletSdkUniffi, which
...
static void cleanup() {
  ...
  // uniffi::chia_wallet_sdk_uniffi::cb::rustfuturecontinuationcallback
...
// Callback function:
// uniffi::chia_wallet_sdk_uniffi::st::foreignfuture::foreignfuture::free::UniffiCallbackInterfaceFree
//
// We have the following constraints:
// - we need to pass a function pointer to Rust.
// - we need a jsi::Runtime and jsi::Function to call into JS.
...
// We then give the `callback` function pointer to Rust which will call the
// lambda sometime in the future.
namespace uniffi::chia_wallet_sdk_uniffi::st::foreignfuture::foreignfuture::
    free {
using namespace facebook;
...
makeCallbackFunction( // uniffi::chia_wallet_sdk_uniffi::st::foreignfuture::foreignfuture::free
    jsi::Runtime &rt,
    std::shared_ptr<uniffi_runtime::UniffiCallInvoker> callInvoker,
    const jsi::Value &value) {
  auto callbackFunction = value.asObject(rt).asFunction(rt);
...
static void cleanup() {
  ...
  // uniffi::chia_wallet_sdk_uniffi::st::foreignfuture::foreignfuture::free
namespace uniffi::chia_wallet_sdk_uniffi {
using namespace facebook;
using CallInvoker = uniffi_runtime::UniffiCallInvoker;
...
template <> struct Bridging<UniffiForeignFuture> {
  static UniffiForeignFuture fromJs(jsi::Runtime &rt,
    ...
    rsObject.free = uniffi::chia_wallet_sdk_uniffi::st::foreignfuture::
...
template <> struct Bridging<UniffiForeignFutureStructU8> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.call_status =
        uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::fromJs(
...
template <> struct Bridging<UniffiForeignFutureCompleteU8> {
  ...
  static jsi::Value intoRust(jsi::Runtime &rt,
    ...
    // then call the rs_callback with those arguments.
    func(uniffi_jsi::Bridging<uint64_t>::fromJs(rt, callInvoker, args[0]),
         uniffi::chia_wallet_sdk_uniffi::Bridging<
...
template <> struct Bridging<UniffiForeignFutureStructRustBuffer> {
  ...
  fromJs(jsi::Runtime &rt, std::shared_ptr<CallInvoker> callInvoker,
    ...
    rsObject.return_value =
        uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "returnValue"));
    rsObject.call_status =
        uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::fromJs(
            rt, callInvoker, jsObject.getProperty(rt, "callStatus"));
...
NativeChiaWalletSdkUniffi::NativeChiaWalletSdkUniffi(
    jsi::Runtime &rt,
  ...
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_from_entropy"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
              "uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_from_entropy"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_from_entropy(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed"),
          2,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_sha256"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_sha256"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_sha256(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic"),
          1,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
          ...
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_from_entropy"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "uniffi_chia_wallet_sdk_uniffi_"
                                        "checksum_func_mnemonic_from_entropy"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
  ...
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_entropy"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(rt, "uniffi_chia_wallet_sdk_uniffi_"
                                        "checksum_func_mnemonic_to_entropy"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
  ...
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
          ...
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed(
                    rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex(
                rt, thisVal, args, count);
          });
  props["uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt,
          ...
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this
                ->cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic(
                    rt, thisVal, args, count);
          });
  props["ffi_chia_wallet_sdk_uniffi_uniffi_contract_version"] =
      jsi::Function::createFromHostFunction(
          rt,
          jsi::PropNameID::forAscii(
              rt, "ffi_chia_wallet_sdk_uniffi_uniffi_contract_version"),
          0,
          [this](jsi::Runtime &rt, const jsi::Value &thisVal,
                 const jsi::Value *args, size_t count) -> jsi::Value {
            return this->cpp_ffi_chia_wallet_sdk_uniffi_uniffi_contract_version(
                rt, thisVal, args, count);
          });
}

void NativeChiaWalletSdkUniffi::registerModule(
    jsi::Runtime &rt, std::shared_ptr<react::CallInvoker> callInvoker) {
  auto invoker =
      std::make_shared<uniffi_runtime::UniffiCallInvoker>(callInvoker);
  auto tm = std::make_shared<NativeChiaWalletSdkUniffi>(rt, invoker);
  auto obj = rt.global().createFromHostObject(rt, tm);
  rt.global().setProperty(rt, "NativeChiaWalletSdkUniffi", obj);
}

void NativeChiaWalletSdkUniffi::unregisterModule(jsi::Runtime &rt) {
  // NOOP
}

jsi::Value NativeChiaWalletSdkUniffi::get(jsi::Runtime &rt,
...
NativeChiaWalletSdkUniffi::getPropertyNames(jsi::Runtime &rt) {
...
void NativeChiaWalletSdkUniffi::set(jsi::Runtime &rt,
                                    const jsi::PropNameID &name,
                                    const jsi::Value &value) {
...
NativeChiaWalletSdkUniffi::~NativeChiaWalletSdkUniffi() {
  ...
  uniffi::chia_wallet_sdk_uniffi::cb::rustfuturecontinuationcallback::cleanup();
...
jsi::Value NativeChiaWalletSdkUniffi::
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes(
        ...
        size_t count) {
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
      rt, callInvoker, status, args[count - 1]);

  return uniffi_jsi::Bridging<int8_t>::toJs(rt, callInvoker, value);
}
jsi::Value
NativeChiaWalletSdkUniffi::cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
  ...
  return uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::toJs(
      rt, callInvoker, value);
}
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value NativeChiaWalletSdkUniffi::
  ...
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic(
...
jsi::Value NativeChiaWalletSdkUniffi::
  ...
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_from_entropy(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value NativeChiaWalletSdkUniffi::
  ...
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value NativeChiaWalletSdkUniffi::
  ...
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[1]),
...
jsi::Value
NativeChiaWalletSdkUniffi::cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_sha256(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_sha256(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value
NativeChiaWalletSdkUniffi::cpp_uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex(
    jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
    size_t count) {
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value NativeChiaWalletSdkUniffi::
  ...
  RustCallStatus status =
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::rustSuccess(rt);
  auto value = uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic(
      uniffi::chia_wallet_sdk_uniffi::Bridging<RustBuffer>::fromJs(
          rt, callInvoker, args[0]),
      &status);
  uniffi::chia_wallet_sdk_uniffi::Bridging<RustCallStatus>::copyIntoJs(
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes();
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex();
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw();
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic();
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex();
...
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic();

  return uniffi_jsi::Bridging<uint16_t>::toJs(rt, callInvoker, value);
}
jsi::Value NativeChiaWalletSdkUniffi::
    cpp_ffi_chia_wallet_sdk_uniffi_uniffi_contract_version(
        jsi::Runtime &rt, const jsi::Value &thisVal, const jsi::Value *args,
        size_t count) {
  auto value = ffi_chia_wallet_sdk_uniffi_uniffi_contract_version();
