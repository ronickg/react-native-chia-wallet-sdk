...
interface NativeModuleInterface {
  ...
  uniffi_chia_wallet_sdk_uniffi_fn_func_compare_bytes(
    a: ArrayBuffer,
    b: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): number;
  uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex(
    hex: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_from_hex_raw(
    hex: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_generate_mnemonic(
    wordCount: number,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  ...
  uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_entropy(
    phrase: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_mnemonic_to_seed(
    phrase: ArrayBuffer,
    passphrase: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_sha256(
    bytes: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_to_hex(
    bytes: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): ArrayBuffer;
  uniffi_chia_wallet_sdk_uniffi_fn_func_validate_mnemonic(
    phrase: ArrayBuffer,
    uniffi_out_err: UniffiRustCallStatus
  ): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_compare_bytes(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_from_hex_raw(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_generate_mnemonic(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_from_entropy(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_entropy(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_mnemonic_to_seed(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_sha256(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_to_hex(): number;
  uniffi_chia_wallet_sdk_uniffi_checksum_func_validate_mnemonic(): number;
  ffi_chia_wallet_sdk_uniffi_uniffi_contract_version(): number;
}

// Casting globalThis to any allows us to look for `NativeChiaWalletSdkUniffi`
// if it was added via JSI.
//
// We use a getter here rather than simply `globalThis.NativeChiaWalletSdkUniffi` so that
// if/when the startup sequence isn't just so, an empty value isn't inadvertantly cached.
const getter: () => NativeModuleInterface = () =>
  (globalThis as any).NativeChiaWalletSdkUniffi;
